...
public class ScaleEffectButton : ButtonInteractive
{
    // —— Private variable ——
    [Header("交互变量")]
   ...
   // ===================
    ...
    private void OnHoverEnter()
    {
        ...
        {
            AudioClip hoverClip = ConfigManager.Get().GetConfig<UIInteractionSound>().scaleBtnHover;
    ...
    private void OnClickEvent()
    {
        ...
        if (ConfigManager.Get().HasConfig<UIInteractionSound>())
        {
            AudioClip selectClip = ConfigManager.Get().GetConfig<UIInteractionSound>().scaleBtnSelect;
